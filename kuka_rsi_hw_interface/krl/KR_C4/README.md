...
This guide highlights the steps needed in order to successfully configure the **KUKA.RobotSensorInterface** on the controller to work with the **kuka_rsi_hardware_interface** on your PC with ROS. The KUKA.RobotSensorInterface module is required to be installed on the controller.
